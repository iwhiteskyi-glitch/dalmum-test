...
export const READS = [
  {
    ...
    description:
      "닮음테스트가 눈·코·입 점수를 매기는 방식을 비전문가도 이해할 수 있게 풀어서 설명합니다.",
    date: "2026-09-10",
  },
  {
    slug: "photo-tips",
    title: "닮음 테스트, 이런 사진으로 하면 결과가 잘 나와요",
    description:
  ...
  {
    slug: "ways-to-enjoy",
    title: "가족·커플·친구… 닮음 테스트 재밌게 즐기는 방법",
    description:
      "혼자서도, 여럿이서도 즐길 수 있는 닮음 테스트 활용 아이디어와 SNS 공유 팁을 모았습니다.",
    date: "2026-09-10",
  },
];
